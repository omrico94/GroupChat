...
public class MyGroupsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseListenerServiceUtils.addChildEventListenerToRemoveList(m_UsersGroupsRef,m_MyGroupsChildEventListener);
    ...
    private void initMyGroupsChildEventListener() {
        ...
        m_MyGroupsChildEventListener = new ChildEventListener() {
            ...
            public void onChildRemoved(DataSnapshot dataSnapshotGroupId) {
                ...
                int index = GroupUtils.findIndexOfGroup(groupsToDisplay, groupId);
                if (index != -1) {
