...
import com.example.groupchatapp.utils.FirebaseListenerServiceUtils;
import com.example.groupchatapp.managers.LoginManager;
import com.example.groupchatapp.models.Group;
import com.example.groupchatapp.interfaces.OnInfoWindowElemTouchListener;
import com.example.groupchatapp.interfaces.OnLocationInit;
import com.example.groupchatapp.interfaces.OnLocationLimitChange;
import com.example.groupchatapp.interfaces.OnLocationPermissionChange;

import com.example.groupchatapp.interfaces.OnLoggedIn;
import com.example.groupchatapp.R;
import com.example.groupchatapp.utils.GroupUtils;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void decideWhatToShowInInfoWindow(Marker currentGroupMarker) {
        ...
        if (!GroupUtils.isGroupInMyLocation(groupToDisplay)) {
    ...
    public void  initGroupsChildEventListener() {
        ...
        m_newGroupsRefChildValueListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                boolean isGroupInMyLocation = GroupUtils.isGroupInMyLocation(groupToAdd);
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String s) {
                ...
                boolean isGroupInMyLocation = GroupUtils.isGroupInMyLocation(changedGroup);
        ...
        m_OnLocationLimitChange=new OnLocationLimitChange() {
            ...
            public void onLimitChange() {
                ...
                for (Map.Entry<String,Marker> pair : markers.entrySet()){
                    ...
                    isGroupInMyLocation = GroupUtils.isGroupInMyLocation(group);
    ...
    public void OnLocationProvide() {
        ...
        FirebaseListenerServiceUtils.addChildEventListenerToRemoveList(m_GroupsRef,m_newGroupsRefChildValueListener);
        ...
        FirebaseListenerServiceUtils.addChildEventListenerToRemoveList(m_UsersGroupsRef,m_UsersGroupsRefChildValueListener);
    ...
    private void initUserGroupsIdListener() {
        ...
        m_UsersGroupsRefChildValueListener = new ChildEventListener() {
            ...
            public void onChildChanged(DataSnapshot dataSnapshotGroupId, String s) {
                ...
                changeMarkerColor(m_LoginManager.getLoggedInUser().getValue().isUserInGroup(groupId), groupId, GroupUtils.isGroupInMyLocation((Group) markers.get(groupId).getTag()));
            }
